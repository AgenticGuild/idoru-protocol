...
export interface AgentIdentityV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "account4337"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "kycAttestation",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace AccountBoundEvent {
  export type InputTuple = [id: BigNumberish, account4337: AddressLike];
  export type OutputTuple = [id: bigint, account4337: string];
...
export namespace AgentRegisteredEvent {
  export type InputTuple = [
    id: BigNumberish,
    owner: AddressLike,
    kycAttestation: BytesLike
  ];
  export type OutputTuple = [id: bigint, owner: string, kycAttestation: string];
  export interface OutputObject {
    id: bigint;
    owner: string;
...
export interface AgentIdentityV2 extends BaseContract {
  connect(runner?: ContractRunner | null): AgentIdentityV2;
  waitForDeployment(): Promise<this>;

  interface: AgentIdentityV2Interface;
  ...
  account4337: TypedContractMethod<[id: BigNumberish], [string], "view">;
  ...
  bindAccount: TypedContractMethod<
    [id: BigNumberish, account4337Account: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  kycAttestation: TypedContractMethod<[id: BigNumberish], [string], "view">;
  ...
  register: TypedContractMethod<
    [to: AddressLike, tokenURI_: string, kycAttestation_: BytesLike],
    [bigint],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "kycAttestation"
  ): TypedContractMethod<[id: BigNumberish], [string], "view">;
  getFunction(
  ...
  getEvent(
    ...
    AccountBoundEvent.InputTuple,
    AccountBoundEvent.OutputTuple,
    AccountBoundEvent.OutputObject
  >;
  getEvent(
    key: "AgentRegistered"
  ): TypedContractEvent<
  ...
  filters: {
    "AccountBound(uint256,address)": TypedContractEvent<
      AccountBoundEvent.InputTuple,
      AccountBoundEvent.OutputTuple,
      AccountBoundEvent.OutputObject
    >;
    AccountBound: TypedContractEvent<
      AccountBoundEvent.InputTuple,
      AccountBoundEvent.OutputTuple,
      AccountBoundEvent.OutputObject
    >;

    "AgentRegistered(uint256,address,bytes32)": TypedContractEvent<
      AgentRegisteredEvent.InputTuple,
      AgentRegisteredEvent.OutputTuple,
      AgentRegisteredEvent.OutputObject
    >;
